    ...
    <div className={`${s.wrap} fade-in`}>
            ...
            >
              <div className={s.questionHeader}>
                ...
                <div className={s.questionMeta}>
                  ...
                  <span
                    className={`${s.diffBadge} ${s[q.difficulty]}`}
                  >
                    {q.difficulty}
                  </span>
                  ...
                  <i
                    className={`ti ti-chevron-right ${s.chevron} ${
                      isOpen ? s.open : ''
                    }`}
                    aria-hidden="true"
                  />
      ...
      <div className={s.section}>
        ...
        {report.tradeoffQuestions.map((t, i) => (
          <div
            key={i}
            className={s.tradeoffCard}
          >
            <div className={s.tradeoffQ}>
              {t.question}
            </div>

            <div className={s.tradeoffA}>
              {t.framework}
            </div>
          </div>
        ))}
      ...
      {/* =====================================================
          COMMON MISTAKES + BEHAVIORAL POINTS
          ===================================================== */}
      ...
      <div className={s.grid2}>
        ...
        <div className={s.section}>
          ...
          <div className={s.card}>
            <ul className={s.list}>
              {report.behavioralPoints.map((b, i) => (
                <li key={i}>
                  {b}
                </li>
              ))}
